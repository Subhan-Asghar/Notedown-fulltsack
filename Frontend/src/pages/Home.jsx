...
const Home = () => {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 h-auto sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
  {note.map((data, index) => (
    <div key={index} className="bg-gradient-to-r from-blue-500 to-blue-400 text-white p-5 rounded-lg shadow-lg transform transition-transform hover:scale-105 hover:shadow-2xl duration-300 h-full">
      ...
      <div className="text-center">
        <p className="text-lg leading-relaxed break-words overflow-hidden">
          {data.note}
        </p>
      </div>
    </div>
